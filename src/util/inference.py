...
from .other import si_sdr, pad_spec, lsd
...
def evaluate_model(model, num_eval_files):
    ...
    for (clean_file, noisy_file) in zip(clean_files, noisy_files):
        ...
        # Reverse sampling
        sampler = model.get_pc_sampler(Y.cuda(), N=N, corrector_steps=corrector_steps, snr=snr)
        sample, _ = sampler()
    ...
    return _pesq/num_eval_files, _si_sdr/num_eval_files, _estoi/num_eval_files, _lsd/num_eval_files
